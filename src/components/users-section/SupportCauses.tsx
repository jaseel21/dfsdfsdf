        ...
        >
          {causes.map((cause) => (
            <motion.div
              ...
              className={`bg-white rounded-2xl shadow-xl overflow-hidden ${activeForm === cause.id ? 'ring-4 ring-indigo-500' : ''
                }`}
            >
              <div className="p-6">
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-2">
                        {donationAmounts.map((amount) => (
                          <button
                            key={amount}
                            type="button"
                            className={`p-2 rounded-lg text-center transition-all ${form.amount === amount
